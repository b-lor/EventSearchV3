...
namespace UserSearch
{
    ...
    public partial class Searches
    {
        public static Searches FromJson(string json) => JsonConvert.DeserializeObject<Searches>(json, UserSearch.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Searches self) => JsonConvert.SerializeObject(self, UserSearch.Converter.Settings);
    }
